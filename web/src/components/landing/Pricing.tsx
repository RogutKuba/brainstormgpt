      ...
      <div className='grid md:grid-cols-2 gap-8 max-w-4xl mx-auto'>
        ...
        <Card className='bg-white/10 backdrop-blur-md border-white/20 text-white overflow-hidden hover:bg-white/15 transition-colors duration-300 h-full flex flex-col'>
          ...
          <CardContent className='pt-6 flex flex-col flex-grow'>
            <ul className='space-y-4 mt-3 text-sm flex-grow'>
          ...
          <CardContent className='pt-6 flex flex-col flex-grow'>
            <ul className='space-y-4 mt-3 text-sm flex-grow'>
              ...
              <li className='flex items-center'>
                ...
                <span className='text-xs font-medium bg-white/10 text-white ml-2 rounded-full px-2.5 py-0.5 border border-white/20 backdrop-blur-sm'>
                  Coming Soon
                </span>
              </li>
              <li className='flex items-start'>
                <RiCheckLine className='mr-3 h-5 w-5 text-green-400 flex-shrink-0 mt-0.5' />
                <span>Chat with your mind map</span>
                <span className='text-xs font-medium bg-white/10 text-white ml-2 rounded-full px-2.5 py-0.5 border border-white/20 backdrop-blur-sm'>
                  Coming Soon
                </span>
              </li>
